...
export default function UpdatePost() {
  ...
  const handleSubmit = async () => {
    ...
    if (file) {
      ...
      try {
        const imgUrl = await axios.post("https://blogtimeserver.herokuapp.com/file/upload", data);
        newPost.photo = imgUrl.data;
      } catch (error) {
        console.log("not uploaded!");
      }
    }
    const post = await axios.put(`https://blogtimeserver.herokuapp.com/api/post/${path}`, newPost);
